 ...
 *
 * Script creating the database schema for Alflytics data warehouse on MySql.
 *
 * Disclaimer:
...
CREATE TABLE `DWH_REPORTS` (`ID` SMALLINT NOT NULL PRIMARY KEY,`NAME` VARCHAR(1024) NOT NULL,`PRPT_PATH` VARCHAR(1024) NOT NULL,`PRPT_NAME` VARCHAR(1024) NOT NULL,`OUTPUT_TYPE` VARCHAR(1024) NOT NULL,`ALF_FTP_HOST` VARCHAR(1024) NOT NULL,`ALF_FTP_PORT` VARCHAR(1024) NOT NULL,`ALF_FTP_LOGIN` VARCHAR(1024) NOT NULL,`ALF_FTP_PASSWORD` VARCHAR(1024) NOT NULL,`ALF_FTP_PATH` VARCHAR(1024) NOT NULL,`IS_ACTIVE` CHARACTER(1) DEFAULT 'Y' NOT NULL);
